...
<form action="<?php echo JRoute::_('index.php?option=com_campaign&view=campaigns'); ?>" method="post" name="adminForm" id="adminForm">
			...
			<table class="table table-striped" id="campaignList">
				...
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_CAMPAIGN_CAMPAIGNS_NAME', 'a.`name`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_CAMPAIGN_CAMPAIGNS_CREATED_TIME', 'a.`created_time`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_CAMPAIGN_CAMPAIGNS_END_DATE', 'a.`end_date`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_CAMPAIGN_CAMPAIGNS_FROM_ZIPCODE', 'a.`from_zipcode`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_CAMPAIGN_CAMPAIGNS_TO_ZIPCODE', 'a.`to_zipcode`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				...
				<?php foreach ($this->items as $i => $item) :
					...
					$canCreate  = $user->authorise('core.create', 'com_campaign');
					$canEdit    = $user->authorise('core.edit', 'com_campaign');
					$canCheckin = $user->authorise('core.manage', 'com_campaign');
					$canChange  = $user->authorise('core.edit.state', 'com_campaign');
					?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_campaign&task=campaign.edit&id='.(int) $item->id); ?>">
				...
				<td>
					...
					<?php echo $item->from_zipcode; ?>
				</td>
				<td>

					<?php echo $item->to_zipcode; ?>
				</td>
				<td>
